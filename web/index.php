...
<head>
  ...
  <style>
    ...
    /* Ganti warna latar belakang jumbotron pada mode malam */
    body.dark-mode .jumbotron-image {
...
<body>
  ...
  <header class="blog-header py-3 dark-mode">
    ...
    <div class="col-4 d-flex justify-content-end align-items-center">
      ...
      <button class="btn btn-link text-muted" onclick="toggleDarkMode()">
        Mode Malam
      </button>
    </div>
    ...
    <div class="container">
      <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
          ...
          <div class="col-4 text-center">
            <a class="blog-header-logo text-dark" href="#">Beranda</a>
          </div>
          <div class="col-4 d-flex justify-content-end align-items-center">
            <a class="text-muted" href="#" aria-label="Search">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="mx-3" role="img" viewBox="0 0 24 24" focusable="false">
      ...
      <div class="container py-5">
        <div class="jumbotron text-white jumbotron-image shadow" style="background-image: url(https://asset.kompas.com/crops/epoluhVtIT10GmnGQFE2PsdUJvE=/0x203:1080x923/750x500/data/photo/2020/11/11/5fabf6158ce8a.jpg);">
          <h2 class="mb-4">
    ...
    <footer class="blog-footer dark-mode">
